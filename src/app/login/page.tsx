      ...
      <div className="w-full max-w-sm">
        ...
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-bg-elevated">
            <NovaIcon size={32} className="text-accent-primary" />
          </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <input
            ...
            className="rounded-lg border border-border-primary bg-bg-elevated px-4 py-3 text-text-primary placeholder:text-text-muted focus:border-accent-primary focus:outline-none focus:ring-1 focus:ring-accent-primary"
            required
            autoComplete="email"
          />
          <input
